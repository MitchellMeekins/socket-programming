...
public class tcp_client {
    ...
    public static void main(String[] args) {
        ...
        try (Socket socket = new Socket(args[0], port)) {
            ...
            measurementOneMilliseconds.add(receiveFile("client/joke1.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke2.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke3.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke4.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke5.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke6.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke7.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke8.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke9.png"));
            measurementOneMilliseconds.add(receiveFile("client/joke10.png"));
            ...
            System.out.println("TCP Setup Time: " + (measurementTwoSecond - measurementTwoFirst) + " milliseconds.");
